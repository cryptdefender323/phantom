...
declare global {
  interface Window {
    ...
    __phantomYoutubeApiPromise?: Promise<YoutubeNamespace>;
  }
}
...
function loadYoutubeIframeApi(): Promise<YoutubeNamespace> {
  ...
  if (window.__phantomYoutubeApiPromise) {
    return window.__phantomYoutubeApiPromise;
  }

  window.__phantomYoutubeApiPromise = new Promise<YoutubeNamespace>((resolve, reject) => {
