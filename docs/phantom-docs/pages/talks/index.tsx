...
const workshopTalks: Talk[] = [
  {
    title:"Getting Started with Phantom v1.6",
  ...
  },
  {
    ...
    description: "From concept to practical encoder strategy in Phantom.",
    url: "https://www.youtube.com/watch?v=6unwFhurm-E",
  },
  {
    title: "Phantom Staging and Automation",
...
const generalTradecraftTalks: Talk[] = [
  ...
  {
    title: "The Phantom C2 Framework",
...
const talkSections: TalkSection[] = [
  {
    key: "workshops",
    title: "Workshops",
    description: "Hands-on workshop recordings focused on Phantom workflows.",
    talks: workshopTalks,
  },
  {
