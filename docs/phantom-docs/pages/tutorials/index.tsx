...
const TutorialsIndexPage: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Phantom Tutorial: {name}</title>
      </Head>
        ...
        <aside className="hidden lg:block lg:col-span-3">
          <div className="sticky top-16 ml-4 flex flex-col gap-3">
            <Input
              ...
              onClear={() => setFilterValue("")}
            />
            <ScrollShadow className="max-h-[calc(100vh-6rem)] phantom-scrollbar overflow-y-auto pr-1 rounded-large">
              <Listbox
        ...
        <div className="px-4 pb-8 lg:col-span-9 lg:px-8">
          {name !== "" ? (
            ...
            <div className="mt-8 text-center text-2xl text-foreground/90">
              Welcome to the Phantom Tutorials!
