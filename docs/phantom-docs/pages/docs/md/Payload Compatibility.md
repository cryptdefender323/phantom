...
- `✅` = first-class support in Phantom's built-in target matrix.
...
Use `generate info` in the Phantom console to see what your current server can build with its configured toolchains.
