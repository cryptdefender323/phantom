...
const (
	markdownDir  = "phantom-docs/pages/docs/md"
	asciinemaDir = "phantom-docs/public/asciinema"
)

var (
	// rawFS stores embedded docs content from the Phantom docs site.
	//go:embed phantom-docs/pages/docs/md/*.md phantom-docs/public/asciinema/*
	rawFS embed.FS
