...
Defines the Cobra root command and CLI initialization for the Phantom client binary. Sets up persistent flags, environment bootstrapping, and command wiring. Core logic addresses console, implant, import, and version within the cli package.
