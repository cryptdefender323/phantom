...
func implantCmd(con *console.PhantomClient) *cobra.Command {
	con.IsCLI = true

	makeCommands := command.PhantomCommands(con)
	cmd := makeCommands()
...
func makeRunners(implantCmd *cobra.Command, con *console.PhantomClient) (pre, post func(cmd *cobra.Command, args []string) error) {
...
func makeCompleters(cmd *cobra.Command, con *console.PhantomClient) {
