...
const (
	logFileName = "phantom-client.log"
)
...
func init() {
	...
	// Implant.
	// The implant command allows users to run commands on phantoms from their
	// system shell. It makes use of pre-runners for connecting to the server
	// and binding phantom commands. These same pre-runners are also used for
