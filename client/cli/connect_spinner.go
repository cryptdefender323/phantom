...
func connectWithSpinner(out io.Writer, target string, connect func(transport.ConnectStatusFn) (rpcpb.PhantomRPCClient, *grpc.ClientConn, error)) (rpcpb.PhantomRPCClient, *grpc.ClientConn, error) {
