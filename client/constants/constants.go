...
const (
	...
	// ConnectedEvent - Phantom Connected.
	SessionOpenedEvent = "session-connected"
	// DisconnectedEvent - Phantom disconnected.
	SessionClosedEvent = "session-disconnected"
	// UpdateEvent - Phantom updated.
...
const (
	...
	DataHelpGroup     = "Data"
	PhantomHelpGroup   = "Phantom"

	// Phantom commands =====================.
	PhantomCoreHelpGroup = "Core"
	InfoHelpGroup       = "Info"
	...
	AliasHelpGroup     = "Phantom - 3rd Party macros"
	ExtensionHelpGroup = "Phantom - 3rd Party extensions"

	// Useless.
	PhantomWinHelpGroup   = "Phantom - Windows"
