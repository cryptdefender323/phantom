...
func (s *PhantomMCPServer) lsHandler(ctx context.Context, request mcpapi.CallToolRequest) (*mcpapi.CallToolResult, error) {
	var args lsArgs
...
func (s *PhantomMCPServer) cdHandler(ctx context.Context, request mcpapi.CallToolRequest) (*mcpapi.CallToolResult, error) {
	var args cdArgs
	if err := request.BindArguments(&args); err != nil {
		return mcpapi.NewToolResultError(fmt.Sprintf("invalid arguments: %v", err)), nil
	}
...
func (s *PhantomMCPServer) catHandler(ctx context.Context, request mcpapi.CallToolRequest) (*mcpapi.CallToolResult, error) {
	var args catArgs
	if err := request.BindArguments(&args); err != nil {
		return mcpapi.NewToolResultError(fmt.Sprintf("invalid arguments: %v", err)), nil
	}
...
func (s *PhantomMCPServer) pwdHandler(ctx context.Context, request mcpapi.CallToolRequest) (*mcpapi.CallToolResult, error) {
	var args pwdArgs
	if err := request.BindArguments(&args); err != nil {
		return mcpapi.NewToolResultError(fmt.Sprintf("invalid arguments: %v", err)), nil
	}
...
func (s *PhantomMCPServer) rmHandler(ctx context.Context, request mcpapi.CallToolRequest) (*mcpapi.CallToolResult, error) {
	var args rmArgs
	if err := request.BindArguments(&args); err != nil {
		return mcpapi.NewToolResultError(fmt.Sprintf("invalid arguments: %v", err)), nil
	}
...
func (s *PhantomMCPServer) mvHandler(ctx context.Context, request mcpapi.CallToolRequest) (*mcpapi.CallToolResult, error) {
	var args mvArgs
	if err := request.BindArguments(&args); err != nil {
		return mcpapi.NewToolResultError(fmt.Sprintf("invalid arguments: %v", err)), nil
	}
...
func (s *PhantomMCPServer) cpHandler(ctx context.Context, request mcpapi.CallToolRequest) (*mcpapi.CallToolResult, error) {
	var args cpArgs
	if err := request.BindArguments(&args); err != nil {
		return mcpapi.NewToolResultError(fmt.Sprintf("invalid arguments: %v", err)), nil
	}
...
func (s *PhantomMCPServer) mkdirHandler(ctx context.Context, request mcpapi.CallToolRequest) (*mcpapi.CallToolResult, error) {
	var args mkdirArgs
	if err := request.BindArguments(&args); err != nil {
		return mcpapi.NewToolResultError(fmt.Sprintf("invalid arguments: %v", err)), nil
	}
...
func (s *PhantomMCPServer) chmodHandler(ctx context.Context, request mcpapi.CallToolRequest) (*mcpapi.CallToolResult, error) {
	var args chmodArgs
	if err := request.BindArguments(&args); err != nil {
		return mcpapi.NewToolResultError(fmt.Sprintf("invalid arguments: %v", err)), nil
	}
...
func (s *PhantomMCPServer) chownHandler(ctx context.Context, request mcpapi.CallToolRequest) (*mcpapi.CallToolResult, error) {
	var args chownArgs
	if err := request.BindArguments(&args); err != nil {
		return mcpapi.NewToolResultError(fmt.Sprintf("invalid arguments: %v", err)), nil
	}
...
func (s *PhantomMCPServer) handleLs(ctx context.Context, args lsArgs) (*mcpapi.CallToolResult, error) {
	if s.Rpc == nil {
	...
	lsResp, err := s.Rpc.Ls(ctx, &phantompb.LsReq{
		Request: req,
		Path:    args.Path,
	})
	if err != nil {
...
func (s *PhantomMCPServer) handleCd(ctx context.Context, args cdArgs) (*mcpapi.CallToolResult, error) {
	if s.Rpc == nil {
		return mcpapi.NewToolResultError("rpc client not configured"), nil
	}
	...
	pwdResp, err := s.Rpc.Cd(ctx, &phantompb.CdReq{
		Request: req,
		Path:    args.Path,
	})
	if err != nil {
...
func (s *PhantomMCPServer) handleCat(ctx context.Context, args catArgs) (*mcpapi.CallToolResult, error) {
	if s.Rpc == nil {
		return mcpapi.NewToolResultError("rpc client not configured"), nil
	}
	...
	download, err := s.Rpc.Download(ctx, &phantompb.DownloadReq{
		Request:          req,
...
func (s *PhantomMCPServer) handlePwd(ctx context.Context, args pwdArgs) (*mcpapi.CallToolResult, error) {
	if s.Rpc == nil {
		return mcpapi.NewToolResultError("rpc client not configured"), nil
	}
	...
	pwdResp, err := s.Rpc.Pwd(ctx, &phantompb.PwdReq{Request: req})
	if err != nil {
...
func (s *PhantomMCPServer) handleRm(ctx context.Context, args rmArgs) (*mcpapi.CallToolResult, error) {
	if s.Rpc == nil {
		return mcpapi.NewToolResultError("rpc client not configured"), nil
	}
	...
	rmResp, err := s.Rpc.Rm(ctx, &phantompb.RmReq{
		Request:   req,
		Path:      args.Path,
...
func (s *PhantomMCPServer) handleMv(ctx context.Context, args mvArgs) (*mcpapi.CallToolResult, error) {
	if s.Rpc == nil {
		return mcpapi.NewToolResultError("rpc client not configured"), nil
	}
	...
	mvResp, err := s.Rpc.Mv(ctx, &phantompb.MvReq{
		Request: req,
		Src:     args.Src,
		Dst:     args.Dst,
	})
...
func (s *PhantomMCPServer) handleCp(ctx context.Context, args cpArgs) (*mcpapi.CallToolResult, error) {
	if s.Rpc == nil {
		return mcpapi.NewToolResultError("rpc client not configured"), nil
	}
	...
	cpResp, err := s.Rpc.Cp(ctx, &phantompb.CpReq{
		Request: req,
		Src:     args.Src,
		Dst:     args.Dst,
	})
...
func (s *PhantomMCPServer) handleMkdir(ctx context.Context, args mkdirArgs) (*mcpapi.CallToolResult, error) {
	if s.Rpc == nil {
		return mcpapi.NewToolResultError("rpc client not configured"), nil
	}
	...
	mkdirResp, err := s.Rpc.Mkdir(ctx, &phantompb.MkdirReq{
		Request: req,
		Path:    args.Path,
	})
	if err != nil {
...
func (s *PhantomMCPServer) handleChmod(ctx context.Context, args chmodArgs) (*mcpapi.CallToolResult, error) {
	if s.Rpc == nil {
		return mcpapi.NewToolResultError("rpc client not configured"), nil
	}
	...
	chmodResp, err := s.Rpc.Chmod(ctx, &phantompb.ChmodReq{
		Request:   req,
		Path:      args.Path,
...
func (s *PhantomMCPServer) handleChown(ctx context.Context, args chownArgs) (*mcpapi.CallToolResult, error) {
	if s.Rpc == nil {
		return mcpapi.NewToolResultError("rpc client not configured"), nil
	}
	...
	chownResp, err := s.Rpc.Chown(ctx, &phantompb.ChownReq{
		Request:   req,
		Path:      args.Path,
		Uid:       args.UID,
		Gid:       args.GID,
...
func (s *PhantomMCPServer) waitForBeaconTaskResponse(ctx context.Context, taskID string, out proto.Message) error {
...
func (s *PhantomMCPServer) waitForBeaconTask(ctx context.Context, taskID string) (*clientpb.BeaconTask, error) {
...
func buildCatResult(download *phantompb.Download, requestedPath string) (*catResult, error) {
	data := download.Data
	decoded := false
