...
func (con *PhantomClient) allowServerRootCommands(args []string) ([]string, error) {
	con.applyCommandFallback(args)
	return args, nil
}

func (con *PhantomClient) prepareCompletion(line []rune, cursor int) {
...
func (con *PhantomClient) applyCommandFallback(args []string) {
	if con == nil || con.App == nil {
		return
	}
...
func (con *PhantomClient) setMenuCommand(menu *console.Menu, args []string) {
	if menu == nil {
		return
	}
...
func (con *PhantomClient) setMenuCommandForCompletion(menu *console.Menu, line []rune, cursor int) {
