...
func CursedEdgeCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func avadaKedavraEdge(session *clientpb.Session, cmd *cobra.Command, con *console.PhantomClient, cargs []string) *core.CursedProcess {
	...
	if edgeProcess != nil {
		...
		con.PrintWarnf("Phantom will need to kill and restart the Edge process in order to perform code injection.\n")
...
func getEdgeProcess(session *clientpb.Session, cmd *cobra.Command, con *console.PhantomClient) (*commonpb.Process, error) {
