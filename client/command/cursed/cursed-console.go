...
func CursedConsoleCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func selectDebugTarget(targets []overlord.ChromeDebugTarget, con *console.PhantomClient) *overlord.ChromeDebugTarget {
	if len(targets) < 1 {
...
func startCursedConsole(curse *core.CursedProcess, helpers bool, target *overlord.ChromeDebugTarget, con *console.PhantomClient) {
