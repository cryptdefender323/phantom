...
func InfoCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	var err error
...
func PIDCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func UIDCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}
...
func GIDCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}
...
func WhoamiCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}
	...
	if isWin {
		cto, err := con.Rpc.CurrentTokenOwner(context.Background(), &phantompb.CurrentTokenOwnerReq{
...
func PrintTokenOwner(cto *phantompb.CurrentTokenOwner, con *console.PhantomClient) {
