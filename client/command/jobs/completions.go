...
func registerWebsiteFlagCompletion(cmd *cobra.Command, name string, con *console.PhantomClient) {
	if cmd == nil {
		return
	}
...
func websiteNameValues(con *console.PhantomClient) ([]string, error) {
