...
Implements the 'socks' command group for the Phantom client console. Handlers map Cobra invocations to socks workflows such as rootcommands, socks start, and socks stop.
