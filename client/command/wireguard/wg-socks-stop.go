...
func WGSocksStopCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	stopReq, err := con.Rpc.WGStopSocks(context.Background(), &phantompb.WGSocksStopReq{
		ID:      int32(socksID),
