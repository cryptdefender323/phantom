...
func WGSocksStartCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	socks, err := con.Rpc.WGStartSocks(context.Background(), &phantompb.WGSocksStartReq{
		Port:    int32(bindPort),
