...
func WGPortFwdAddCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	portfwdAdd, err := con.Rpc.WGStartPortForward(context.Background(), &phantompb.WGPortForwardStartReq{
		LocalPort:     localPort,
