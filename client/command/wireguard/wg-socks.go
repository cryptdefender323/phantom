...
func WGSocksListCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	socksList, err := con.Rpc.WGListSocksServers(context.Background(), &phantompb.WGSocksServersReq{
...
func SocksIDCompleter(con *console.PhantomClient) carapace.Action {
