...
func MonitorConfigCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func MonitorAddConfigCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func MonitorDelConfigCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func PrintWTConfig(configs *clientpb.MonitoringProviders, con *console.PhantomClient) {
	tw := table.NewWriter()
