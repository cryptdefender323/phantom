...
func CredsAddCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
// CredsCmd - Add new credentials.
func CredsAddHashFileCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	collection, _ := cmd.Flags().GetString("collection")
	filePath := args[0]
