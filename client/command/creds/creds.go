...
func CredsCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func PrintCreds(creds []*clientpb.Credential, con *console.PhantomClient) {
...
func printCollection(collection string, creds []*clientpb.Credential, con *console.PhantomClient) {
	tw := table.NewWriter()
...
func CredsHashTypeCompleter(con *console.PhantomClient) carapace.Action {
...
func CredsHashFileFormatCompleter(con *console.PhantomClient) carapace.Action {
...
func CredsCollectionCompleter(con *console.PhantomClient) carapace.Action {
	return carapace.ActionCallback(func(c carapace.Context) carapace.Action {
		results := make([]string, 0)
...
func CredsCredentialIDCompleter(con *console.PhantomClient) carapace.Action {
	return carapace.ActionCallback(func(c carapace.Context) carapace.Action {
		results := make([]string, 0)
