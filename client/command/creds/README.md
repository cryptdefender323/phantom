...
Implements the 'creds' command group for the Phantom client console. Handlers map Cobra invocations to creds workflows such as ADD, hash types, RM, and select.
