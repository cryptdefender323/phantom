...
func TasksCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func PrintBeaconTasks(tasks []*clientpb.BeaconTask, cmd *cobra.Command, con *console.PhantomClient) {
	tw := table.NewWriter()
