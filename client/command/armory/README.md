...
Implements the 'armory' command group for the Phantom client console. Handlers map Cobra invocations to armory workflows such as install, manage, parsers, and search.
