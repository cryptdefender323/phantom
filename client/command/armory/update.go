...
func ArmoryUpdateCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func displayAvailableUpdates(con *console.PhantomClient, updateKeys []UpdateIdentifier, aliasUpdates, extensionUpdates map[string]VersionInformation) {
	var (
		aliasSuffix     string
