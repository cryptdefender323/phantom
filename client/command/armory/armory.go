...
func ArmoryCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func PrintArmoryPackages(aliases []*alias.AliasManifest, exts []*extensions.ExtensionManifest, con *console.PhantomClient) {
	...
	for _, pkg := range entries {
		...
		if extensions.CmdExists(pkg.CommandName, phantomMenu.Command) {
...
func PrintArmoryBundles(bundles []*ArmoryBundle, con *console.PhantomClient) {
	tw := table.NewWriter()
	tw.SetStyle(settings.GetTableStyle(con))
