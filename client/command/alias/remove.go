...
// AliasesRemoveCmd - Locally load a alias into the Phantom shell.
func AliasesRemoveCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	name := args[0]
...
func RemoveAliasByCommandName(commandName string, con *console.PhantomClient) error {
	if commandName == "" {
