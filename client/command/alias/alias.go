...
func AliasesCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) error {
...
func PrintAliases(con *console.PhantomClient) {
	tw := table.NewWriter()
...
func AliasCommandNameCompleter(prefix string, args []string, con *console.PhantomClient) []string {
	results := []string{}
