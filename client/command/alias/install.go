...
func AliasesInstallCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func installFromDir(aliasLocalPath string, con *console.PhantomClient) {
...
func InstallFromFile(aliasGzFilePath string, aliasName string, promptToOverwrite bool, con *console.PhantomClient) *string {
