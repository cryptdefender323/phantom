...
func ExtensionsCmd(cmd *cobra.Command, con *console.PhantomClient) {
...
func PrintExtensions(con *console.PhantomClient) {
	tw := table.NewWriter()
...
func ExtensionsCommandNameCompleter(con *console.PhantomClient) carapace.Action {
