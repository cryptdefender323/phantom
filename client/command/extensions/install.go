...
func ExtensionsInstallCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	extLocalPath := args[0]
...
// InstallFromDir installs a Phantom extension from either a local directory or gzipped archive.
...
//   - con: Phantom console client for displaying status and error messages
...
func InstallFromDir(extLocalPath string, promptToOverwrite bool, con *console.PhantomClient, isGz bool) {
