...
func ExtensionsRemoveCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	name := args[0]
	if name == "" {
...
func RemoveExtensionByCommandName(commandName string, con *console.PhantomClient) error {
	if commandName == "" {
...
func RemoveExtensionByManifestName(manifestName string, con *console.PhantomClient) (bool, error) {
	if manifestName == "" {
