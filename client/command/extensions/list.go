...
func PrintExtensionMatches(matches map[string]*ExtensionMatch, con *console.PhantomClient) {
	tw := table.NewWriter()
...
func ExtensionsListCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
