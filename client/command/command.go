...
func makeBind(cmd *cobra.Command, con *client.PhantomClient) func(group string, cmds ...func(con *client.PhantomClient) []*cobra.Command) {
	return func(group string, cmds ...func(con *client.PhantomClient) []*cobra.Command) {
		found := false
...
// type commandBinder func(group string, cmds ...func(con *client.PhantomClient) []*cobra.Command)
