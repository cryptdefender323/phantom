...
func registerSessionIDFlagCompletion(cmd *cobra.Command, name string, con *console.PhantomClient) {
	if cmd == nil {
		return
	}
...
func sessionCompletionPairs(con *console.PhantomClient) []string {
...
// PhantomCommands returns all session control commands for the active target.
func PhantomCommands(con *console.PhantomClient) []*cobra.Command {
