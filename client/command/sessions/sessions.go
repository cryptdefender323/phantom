...
func SessionsCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func PrintSessions(sessions map[string]*clientpb.Session, filter string, filterRegex *regexp.Regexp, con *console.PhantomClient) {
