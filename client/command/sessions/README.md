...
Implements the 'sessions' command group for the Phantom client console. Handlers map Cobra invocations to sessions workflows such as background, close, interactive, and prune.
