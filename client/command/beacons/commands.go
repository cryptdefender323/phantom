...
func BeaconIDCompleter(con *console.PhantomClient) carapace.Action {
...
func registerBeaconIDFlagCompletion(cmd *cobra.Command, name string, con *console.PhantomClient) {
	if cmd == nil {
		return
	}
...
func beaconCompletionPairs(con *console.PhantomClient) []string {
