...
var (
	tableStyles = map[string]table.Style{
		// Phantom styles
		PhantomDefault.Name: PhantomDefault,
	...
	phantomBordersDefault = table.Style{
		Name: "PhantomBordersDefault",
		Box: table.BoxStyle{
			BottomLeft:       "+",
			BottomRight:      "+",
			BottomSeparator:  "-",
...
func GetTableStyle(con *console.PhantomClient) table.Style {
	if con.Settings == nil {
	...
	return tableStyles[PhantomDefault.Name]
}

// GetTableWithBordersStyle - Get the table style with borders.
func GetTableWithBordersStyle(con *console.PhantomClient) table.Style {
	if con.Settings == nil {
		con.Settings, _ = assets.LoadSettings()
	}
	value, ok := tableStyles[con.Settings.TableStyle]
	if !ok || con.Settings.TableStyle == PhantomDefault.Name {
		return phantomBordersDefault
	}
	return value
}
...
func PaginateTable(tw table.Writer, skipPages int, overflow bool, interactive bool, con *console.PhantomClient) {
