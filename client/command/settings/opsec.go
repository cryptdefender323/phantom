...
func SettingsAutoAdultCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	var err error
	if con.Settings == nil {
...
func IsUserAnAdult(con *console.PhantomClient) bool {
...
func IsUserAnAdultWithPrompt(con *console.PhantomClient, prompt string) bool {
	if GetAutoAdult(con) {
		return true
	}
	confirm := false
...
func GetAutoAdult(con *console.PhantomClient) bool {
	if con.Settings == nil {
