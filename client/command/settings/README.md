...
Implements the 'settings' command group for the Phantom client console. Handlers map Cobra invocations to settings workflows such as beacons, opsec, and tables.
