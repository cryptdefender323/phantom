...
Implements the 'loot' command group for the Phantom client console. Handlers map Cobra invocations to loot workflows such as fetch, local, remote, and rename.
