...
func LootCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func PrintAllFileLootTable(allLoot *clientpb.AllLoot, con *console.PhantomClient) {
...
func PrintLootFile(loot *clientpb.Loot, con *console.PhantomClient) {
	if loot.File == nil {
		return
	}
	if loot.File.Name != "" {
