...
func AddLootFile(rpc rpcpb.PhantomRPCClient, name string, fileName string, data []byte, isCredential bool) error {
	if len(data) < 1 {
...
func SelectLoot(cmd *cobra.Command, rpc rpcpb.PhantomRPCClient) (*clientpb.Loot, error) {
