...
Implements the 'reaction' command group for the Phantom client console. Handlers map Cobra invocations to reaction workflows such as reload, save, SET, and unset.
