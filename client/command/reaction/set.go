...
func ReactionSetCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func getEventType(cmd *cobra.Command, con *console.PhantomClient) (string, error) {
...
func selectEventType(con *console.PhantomClient) (string, error) {
	selection := ""
