...
func ReactionCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	totalReactions := 0
...
func displayReactionsTable(eventType string, reactions []core.Reaction, con *console.PhantomClient) {
	tw := table.NewWriter()
