...
// func HelpCmd(con *console.PhantomConsole) func(a *grumble.App, shell bool) {
// 	return func(a *grumble.App, shell bool) {
// 		printHelp(con)
// 	}
// }

// func printHelp(con *console.PhantomConsole) {
...
// 			if targetOS != "windows" && key == consts.PhantomWinHelpGroup {
// 				continue
// 			}
// 		} else {
// 			if key == consts.PhantomHelpGroup || key == consts.PhantomWinHelpGroup || key == consts.AliasHelpGroup || key == consts.ExtensionHelpGroup {
// 				continue
// 			}
// 		}
// 		if len(key) == 0 {
...
//
// 	con.Println()
// 	con.Printf("For even more information, please see our wiki: https://github.com/cryptdefender3232/phantom/wiki\n")
// 	con.Println()
// }
//
// func headlinePrinter(c *grumble.Config, con *console.PhantomConsole) func(v ...interface{}) (int, error) {
...
// }
//
// func printHeadline(config *grumble.Config, s string, con *console.PhantomConsole) {
