...
func ShellcodeEncoderNameCompleter(con *console.PhantomClient) carapace.Action {
...
func ShellcodeEncoderArchCompleter(con *console.PhantomClient) carapace.Action {
	return carapace.ActionCallback(func(c carapace.Context) carapace.Action {
		encoderMap, err := fetchShellcodeEncoderMap(con)
		if err != nil {
			return carapace.ActionMessage("failed to fetch shellcode encoders: %s", err.Error())
