...
func ShellcodeEncodersCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func DisplayShellcodeEncoders(encoderMap *clientpb.ShellcodeEncoderMap, con *console.PhantomClient) {
