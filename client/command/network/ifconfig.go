...
func IfconfigCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}
	ifconfig, err := con.Rpc.Ifconfig(context.Background(), &phantompb.IfconfigReq{
...
func PrintIfconfig(ifconfig *phantompb.Ifconfig, all bool, con *console.PhantomClient) {
	var err error
