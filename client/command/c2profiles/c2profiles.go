...
func C2ProfileCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func ImportC2ProfileCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	profileName, _ := cmd.Flags().GetString("name")
	if profileName == "" {
...
func ExportC2ProfileCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func GenerateC2ProfileCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func PrintC2Profiles(profile *clientpb.HTTPC2Config, con *console.PhantomClient) {
