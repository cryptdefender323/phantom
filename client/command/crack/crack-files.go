...
func CrackWordlistsCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func CrackRulesCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func CrackHcstat2Cmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func PrintCrackFiles(crackFiles *clientpb.CrackFiles, con *console.PhantomClient) {
	tw := table.NewWriter()
...
func PrintCrackFilesByType(crackFiles *clientpb.CrackFiles, con *console.PhantomClient) {
...
func CrackWordlistsAddCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func CrackRulesAddCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	name, _ := cmd.Flags().GetString("name")
...
func CrackHcstat2AddCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	name, _ := cmd.Flags().GetString("name")
...
func addCrackFile(localFile *os.File, crackFile *clientpb.CrackFile, con *console.PhantomClient) {
	digest := sha256.New()
...
func chunkReader(wordlistReader io.Reader, chunkSize int64, chunks chan []byte) error {
	defer close(chunks)
	start := int64(0)
	tmpFile, err := os.CreateTemp("", "phantom-wordlist")
	if err != nil {
		return err
	}
	defer tmpFile.Close()
...
func CrackWordlistsRmCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func CrackRulesRmCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func CrackHcstat2RmCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
