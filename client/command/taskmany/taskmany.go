...
func Command(con *console.PhantomClient) []*cobra.Command {
	...
	// for _, c := range PhantomCommands(con)().Commands() {
...
func TaskmanyCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func WrapCommand(c *cobra.Command, con *console.PhantomClient) *cobra.Command {
	wc := &cobra.Command{
		Use:   c.Use,
		Short: c.Short,
		Long:  c.Long,
...
func wrapFunctionWithTaskmany(con *console.PhantomClient, f func(cmd *cobra.Command, args []string)) func(cmd *cobra.Command, args []string) {
...
func SelectMultipleBeaconsAndSessions(con *console.PhantomClient) ([]*clientpb.Session, []*clientpb.Beacon, error) {
