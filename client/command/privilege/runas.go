...
func RunAsCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	runAs, err := con.Rpc.RunAs(context.Background(), &phantompb.RunAsReq{
...
func PrintRunAs(runAs *phantompb.RunAs, process string, args string, name string, con *console.PhantomClient) {
