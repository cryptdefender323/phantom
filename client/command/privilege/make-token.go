...
func MakeTokenCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	makeToken, err := con.Rpc.MakeToken(context.Background(), &phantompb.MakeTokenReq{
...
func PrintMakeToken(makeToken *phantompb.MakeToken, domain string, username string, con *console.PhantomClient) {
