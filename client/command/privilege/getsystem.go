...
func GetSystemCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	*/
	...
	ctrl := make(chan bool)
	con.SpinUntil("Attempting to create a new phantom session as 'NT AUTHORITY\\SYSTEM'...", ctrl)
...
func PrintGetSystem(getsystemResp *phantompb.GetSystem, con *console.PhantomClient) {
