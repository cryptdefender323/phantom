...
Implements the 'privilege' command group for the Phantom client console. Handlers map Cobra invocations to privilege workflows such as getprivs, getsystem, impersonate, and make token.
