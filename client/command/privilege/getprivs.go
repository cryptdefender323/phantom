...
func GetPrivsCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	privs, err := con.Rpc.GetPrivs(context.Background(), &phantompb.GetPrivsReq{
...
func PrintGetPrivs(privs *phantompb.GetPrivs, pid int32, con *console.PhantomClient) {
...
func updateBeaconIntegrityInformation(con *console.PhantomClient, beaconID string, integrity string) error {
