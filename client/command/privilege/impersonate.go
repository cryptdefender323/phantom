...
func ImpersonateCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	username := args[0]
	impersonate, err := con.Rpc.Impersonate(context.Background(), &phantompb.ImpersonateReq{
...
func PrintImpersonate(impersonate *phantompb.Impersonate, username string, con *console.PhantomClient) {
