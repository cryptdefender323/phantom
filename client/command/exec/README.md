...
Implements the 'exec' command group for the Phantom client console. Handlers map Cobra invocations to exec workflows such as execute assembly, execute shellcode, execute, and migrate.
