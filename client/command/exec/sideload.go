...
func SideloadCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	sideload, err := con.Rpc.Sideload(context.Background(), &phantompb.SideloadReq{
...
func HandleSideloadResponse(sideload *phantompb.Sideload, binPath string, hostName string, cmd *cobra.Command, con *console.PhantomClient) {
