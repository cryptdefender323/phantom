...
func SpawnDllCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	spawndll, err := con.Rpc.SpawnDll(context.Background(), &phantompb.InvokeSpawnDllReq{
		Data:        binData,
...
func HandleSpawnDLLResponse(spawndll *phantompb.SpawnDll, binPath string, hostName string, cmd *cobra.Command, con *console.PhantomClient) {
