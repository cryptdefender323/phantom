...
func MigrateCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func parseShellcodeEncoderFlag(cmd *cobra.Command, targetArch string, con *console.PhantomClient) (clientpb.ShellcodeEncoder, error) {
