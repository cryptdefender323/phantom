...
func ExecuteAssemblyCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	execAssembly, err := con.Rpc.ExecuteAssembly(context.Background(), &phantompb.ExecuteAssemblyReq{
...
func HandleExecuteAssemblyResponse(execAssembly *phantompb.ExecuteAssembly, assemblyPath string, hostName string, cmd *cobra.Command, con *console.PhantomClient) {
