...
func KillCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func KillSession(session *clientpb.Session, cmd *cobra.Command, con *console.PhantomClient) error {
	if session == nil {
...
func KillBeacon(beacon *clientpb.Beacon, cmd *cobra.Command, con *console.PhantomClient) error {
	if beacon == nil {
		return errors.New("session does not exist")
	}
