...
func BuildersCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func PrintBuilders(externalBuilders []*clientpb.Builder, con *console.PhantomClient) {
	tw := table.NewWriter()
