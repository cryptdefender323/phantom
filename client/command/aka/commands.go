...
func ImplantCommands(con *console.PhantomClient) []*cobra.Command {
	return commands(con, constants.PhantomCoreHelpGroup)
}

func commands(con *console.PhantomClient, group string) []*cobra.Command {
