...
func HostsIOCCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func hostIOCsTable(host *clientpb.Host, con *console.PhantomClient) string {
	tw := table.NewWriter()
...
func SelectHostIOC(host *clientpb.Host, con *console.PhantomClient) (*clientpb.IOC, error) {
