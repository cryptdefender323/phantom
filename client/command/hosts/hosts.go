...
func HostsCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func hostsTable(hosts []*clientpb.Host, con *console.PhantomClient) string {
	tw := table.NewWriter()
...
func hostSessions(hostUUID string, con *console.PhantomClient) string {
...
func hostBeacons(hostUUID string, con *console.PhantomClient) string {
...
func SessionsForHost(hostUUID string, con *console.PhantomClient) []*clientpb.Session {
...
func SelectHost(con *console.PhantomClient) (*clientpb.Host, error) {
	allHosts, err := con.Rpc.Hosts(context.Background(), &commonpb.Empty{})
	if err != nil {
		return nil, err
	}
