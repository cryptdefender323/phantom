...
Implements the 'hosts' command group for the Phantom client console. Handlers map Cobra invocations to hosts workflows such as hosts IOC RM, hosts IOC, and hosts RM.
