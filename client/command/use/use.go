...
func registerUseIDCompletion(cmd *cobra.Command, con *console.PhantomClient, includeSessions, includeBeacons bool) {
...
func useCompletionValues(con *console.PhantomClient, includeSessions, includeBeacons bool) []string {
	results := []string{}
...
func UseCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func SessionOrBeaconByID(id string, con *console.PhantomClient) (*clientpb.Session, *clientpb.Beacon, error) {
	sessions, err := con.Rpc.GetSessions(context.Background(), &commonpb.Empty{})
	if err != nil {
		return nil, nil, err
	} else {
...
func SelectSessionOrBeacon(con *console.PhantomClient) (*clientpb.Session, *clientpb.Beacon, error) {
...
func BeaconAndSessionIDCompleter(con *console.PhantomClient) carapace.Action {
...
func SessionIDCompleter(con *console.PhantomClient) carapace.Action {
