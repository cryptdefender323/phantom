...
func ScreenshotCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	screenshot, err := con.Rpc.Screenshot(context.Background(), &phantompb.ScreenshotReq{
...
func PrintScreenshot(screenshot *phantompb.Screenshot, hostname string, cmd *cobra.Command, con *console.PhantomClient) {
...
func LootScreenshot(screenshot *phantompb.Screenshot, lootName string, hostName string, con *console.PhantomClient) {
