...
func MemfilesListCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}

	memfilesList, err := con.Rpc.MemfilesList(context.Background(), &phantompb.MemfilesListReq{
...
// PrintMemfiles - Display an phantompb.Ls object.
func PrintMemfiles(ls *phantompb.Ls, con *console.PhantomClient) {
