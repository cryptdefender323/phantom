...
func RmCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	rm, err := con.Rpc.Rm(context.Background(), &phantompb.RmReq{
...
func PrintRm(rm *phantompb.Rm, con *console.PhantomClient) {
