...
func MemfilesRmCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	memfilesList, err := con.Rpc.MemfilesRm(context.Background(), &phantompb.MemfilesRmReq{
...
func PrintRmMemfile(memfilesList *phantompb.MemfilesRm, con *console.PhantomClient) {
