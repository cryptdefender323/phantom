...
func LsCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
// PrintLs - Display an phantompb.Ls object.
func PrintLs(ls *phantompb.Ls, flags *pflag.FlagSet, con *console.PhantomClient) {
