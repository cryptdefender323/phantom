...
func CpCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) (err error) {
	...
	cp, err := con.Rpc.Cp(context.Background(), &phantompb.CpReq{
...
func PrintCp(cp *phantompb.Cp, con *console.PhantomClient) {
