...
func CatCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func PrintCat(originalFileName string, download *phantompb.Download, cmd *cobra.Command, con *console.PhantomClient) {
	var (
...
func colorize(f *phantompb.Download) error {
