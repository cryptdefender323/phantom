...
func MemfilesAddCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}

	memfilesAdd, err := con.Rpc.MemfilesAdd(context.Background(), &phantompb.MemfilesAddReq{
...
func PrintAddMemfile(memfilesAdd *phantompb.MemfilesAdd, con *console.PhantomClient) {
