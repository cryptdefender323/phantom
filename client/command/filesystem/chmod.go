...
func ChmodCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	chmod, err := con.Rpc.Chmod(context.Background(), &phantompb.ChmodReq{
...
func PrintChmod(chmod *phantompb.Chmod, con *console.PhantomClient) {
