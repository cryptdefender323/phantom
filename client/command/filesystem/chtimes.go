...
func ChtimesCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	chtimes, err := con.Rpc.Chtimes(context.Background(), &phantompb.ChtimesReq{
...
func PrintChtimes(chtimes *phantompb.Chtimes, con *console.PhantomClient) {
