...
func PwdCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}
	pwd, err := con.Rpc.Pwd(context.Background(), &phantompb.PwdReq{
...
func PrintPwd(pwd *phantompb.Pwd, con *console.PhantomClient) {
