...
func MkdirCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	mkdir, err := con.Rpc.Mkdir(context.Background(), &phantompb.MkdirReq{
...
func PrintMkdir(mkdir *phantompb.Mkdir, con *console.PhantomClient) {
