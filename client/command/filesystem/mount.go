...
func MountCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}
	mount, err := con.Rpc.Mount(context.Background(), &phantompb.MountReq{
...
func PrintMount(os string, mount *phantompb.Mount, con *console.PhantomClient) {
...
func mountRow(os string, mountInfo *phantompb.MountInfo) table.Row {
	var row table.Row
