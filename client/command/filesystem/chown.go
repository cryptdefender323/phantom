...
func ChownCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	chown, err := con.Rpc.Chown(context.Background(), &phantompb.ChownReq{
...
func PrintChown(chown *phantompb.Chown, con *console.PhantomClient) {
