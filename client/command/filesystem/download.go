...
func DownloadCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func HandleDownloadResponse(download *phantompb.Download, cmd *cobra.Command, args []string, con *console.PhantomClient) {
	var err error
