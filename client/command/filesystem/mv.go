...
func MvCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) (err error) {
	...
	mv, err := con.Rpc.Mv(context.Background(), &phantompb.MvReq{
...
func PrintMv(mv *phantompb.Mv, con *console.PhantomClient) {
