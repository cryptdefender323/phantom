...
func PortfwdCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	PrintPortfwd(con)
}

// PrintPortfwd - Print the port forward(s).
func PrintPortfwd(con *console.PhantomClient) {
...
func PortfwdIDCompleter(_ *console.PhantomClient) carapace.Action {
