...
Implements the 'portfwd' command group for the Phantom client console. Handlers map Cobra invocations to portfwd workflows such as portfwd ADD and portfwd RM.
