...
func EditCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func downloadRemote(ctx context.Context, con *console.PhantomClient, cmd *cobra.Command, path string) (*phantompb.Download, error) {
