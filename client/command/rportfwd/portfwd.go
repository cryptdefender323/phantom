...
func RportFwdListenersCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	session := con.ActiveTarget.GetSessionInteractive()
	if session == nil {
		return
	}

	rportfwdListeners, err := con.Rpc.GetRportFwdListeners(context.Background(), &phantompb.RportFwdListenersReq{
...
func PrintRportFwdListeners(rportfwdListeners *phantompb.RportFwdListeners, flags *pflag.FlagSet, con *console.PhantomClient) {
...
func PortfwdIDCompleter(con *console.PhantomClient) carapace.Action {
