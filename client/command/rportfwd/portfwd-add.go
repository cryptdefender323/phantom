...
func StartRportFwdListenerCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	rportfwdListener, err := con.Rpc.StartRportFwdListener(context.Background(), &phantompb.RportFwdStartListenerReq{
...
func printStartedRportFwdListener(rportfwdListener *phantompb.RportFwdListener, con *console.PhantomClient) {
