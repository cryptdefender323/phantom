...
func PivotDetailsCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func PrintPivotListenerDetails(listener *phantompb.PivotListener, con *console.PhantomClient) {
	con.Printf("\n")
	con.Printf("               ID: %d\n", listener.ID)
