...
func StopPivotListenerCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	_, err := con.Rpc.PivotStopListener(context.Background(), &phantompb.PivotStopListenerReq{
		ID:      id,
		Request: con.ActiveTarget.Request(cmd),
	})
	if err != nil {
