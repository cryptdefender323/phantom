...
Implements the 'pivots' command group for the Phantom client console. Handlers map Cobra invocations to pivots workflows such as details, graph, start, and stop.
