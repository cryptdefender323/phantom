...
func SelectPivotListener(listeners []*phantompb.PivotListener, con *console.PhantomClient) (*phantompb.PivotListener, error) {
...
func PivotIDCompleter(con *console.PhantomClient) carapace.Action {
