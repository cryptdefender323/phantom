...
func TestSummarizeMarkdownStripsMarkdownAndUnicodeSymbols(t *testing.T) {
	summary := summarizeMarkdown("⚠️ **IMPORTANT:** This content was NOT created by the Phantom authors.")
	if summary != "IMPORTANT: This content was NOT created by the Phantom authors." {
