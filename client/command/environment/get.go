...
func EnvGetCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	envInfo, err := con.Rpc.GetEnv(context.Background(), &phantompb.EnvReq{
		Name:    name,
...
func PrintGetEnvInfo(envInfo *phantompb.EnvInfo, con *console.PhantomClient) {
