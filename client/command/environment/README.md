...
Implements the 'environment' command group for the Phantom client console. Handlers map Cobra invocations to environment workflows such as GET, SET, and unset.
