...
func RegDeleteKeyCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	deleteKey, err := con.Rpc.RegistryDeleteKey(context.Background(), &phantompb.RegistryDeleteKeyReq{
		Hive:     hive,
		Path:     finalPath,
		Key:      key,
		Hostname: hostname,
...
func PrintDeleteKey(deleteKey *phantompb.RegistryDeleteKey, regPath string, key string, con *console.PhantomClient) {
