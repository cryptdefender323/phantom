...
func RegWriteCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	regWrite, err := con.Rpc.RegistryWrite(context.Background(), &phantompb.RegistryWriteReq{
...
func PrintRegWrite(regWrite *phantompb.RegistryWrite, con *console.PhantomClient) {
