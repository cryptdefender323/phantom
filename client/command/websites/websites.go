...
func WebsitesCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	if len(args) > 0 {
		websiteName := args[0]
...
func ListWebsites(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func ListWebsiteContent(websiteName string, con *console.PhantomClient) {
...
func PrintWebsite(web *clientpb.Website, con *console.PhantomClient) {
...
func WebsiteNameCompleter(con *console.PhantomClient) carapace.Action {
