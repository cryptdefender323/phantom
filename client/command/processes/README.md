...
Implements the 'processes' command group for the Phantom client console. Handlers map Cobra invocations to processes workflows such as procdump, PS, pstree, and terminate.
