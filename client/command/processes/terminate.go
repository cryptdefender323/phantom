...
func TerminateCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	terminated, err := con.Rpc.Terminate(context.Background(), &phantompb.TerminateReq{
...
func PrintTerminate(terminated *phantompb.Terminate, con *console.PhantomClient) {
