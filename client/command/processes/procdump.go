...
func ProcdumpCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	dump, err := con.Rpc.ProcessDump(context.Background(), &phantompb.ProcessDumpReq{
...
func PrintProcessDump(dump *phantompb.ProcessDump, saveTo string, hostname string, pid int, con *console.PhantomClient) {
	var err error
...
func LootProcessDump(dump *phantompb.ProcessDump, lootName string, hostName string, pid int, con *console.PhantomClient) {
