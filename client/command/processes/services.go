...
func ServicesCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	...
	services, err := con.Rpc.Services(context.Background(), &phantompb.ServicesReq{
		Hostname: hostname,
...
func ServiceInfoCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}
	...
	serviceInfo, err := con.Rpc.ServiceDetail(context.Background(), &phantompb.ServiceDetailReq{
		ServiceInfo: &phantompb.ServiceInfoReq{Hostname: hostname, ServiceName: serviceName},
		Request:     con.ActiveTarget.Request(cmd),
	})
...
func ServiceStopCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}
	...
	stopService, err := con.Rpc.StopService(context.Background(), &phantompb.StopServiceReq{
		ServiceInfo: &phantompb.ServiceInfoReq{Hostname: hostname, ServiceName: serviceName},
		Request:     con.ActiveTarget.Request(cmd),
	})
...
func ServiceStartCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	session, beacon := con.ActiveTarget.GetInteractive()
	if session == nil && beacon == nil {
		return
	}
	...
	startService, err := con.Rpc.StartServiceByName(context.Background(), &phantompb.StartServiceByNameReq{
		ServiceInfo: &phantompb.ServiceInfoReq{Hostname: hostname, ServiceName: serviceName},
		Request:     con.ActiveTarget.Request(cmd),
	})
...
func PrintServices(serviceInfo *phantompb.Services, con *console.PhantomClient) {
	// Get terminal width
...
func PrintServiceDetail(serviceDetail *phantompb.ServiceDetail, con *console.PhantomClient) {
