...
func Commands(con *console.PhantomClient) []*cobra.Command {
	return []*cobra.Command{newAICommand(consts.PhantomCoreHelpGroup, con)}
}
...
func newAICommand(groupID string, con *console.PhantomClient) *cobra.Command {
	return &cobra.Command{
		Use:     consts.AIStr,
		Short:   "Open the Phantom AI conversation TUI",
