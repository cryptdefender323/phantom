...
import (
	...
	"github.com/cryptdefender3232/phantom/client/termio"
...
func AICmd(_ *cobra.Command, con *console.PhantomClient, _ []string) {
...
func buildAIContext(con *console.PhantomClient) aiContext {
	ctx := aiContext{
