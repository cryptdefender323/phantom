...
func CertificateAuthoritiesCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func printCertificateAuthorityInfo(con *console.PhantomClient, authData []*clientpb.CertificateAuthorityData) {
