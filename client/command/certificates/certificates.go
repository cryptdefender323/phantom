...
func CertificateInfoCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func printCertificateInfo(con *console.PhantomClient, certData []*clientpb.CertificateData) {
