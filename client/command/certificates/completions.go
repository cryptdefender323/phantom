...
func CertificateCommonNameCompleter(con *console.PhantomClient) carapace.Action {
...
func registerCertificateCNFlagCompletion(cmd *cobra.Command, name string, con *console.PhantomClient) {
	if cmd == nil {
		return
	}
...
func certificateCommonNameValues(con *console.PhantomClient) ([]string, error) {
	if con == nil || con.Rpc == nil {
		return nil, nil
	}
