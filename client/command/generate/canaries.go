...
func CanariesCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func PrintCanaries(con *console.PhantomClient, canaries []*clientpb.DNSCanary, burnedOnly bool) {
	tw := table.NewWriter()
