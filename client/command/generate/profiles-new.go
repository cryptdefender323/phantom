...
func ProfilesNewCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	var name string
...
func ProfilesNewBeaconCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
	var name string
...
func shouldRunGenerateProfilesNewForm(cmd *cobra.Command, con *console.PhantomClient, args []string) bool {
...
func shouldRunGenerateProfilesNewBeaconForm(cmd *cobra.Command, con *console.PhantomClient, args []string) bool {
	if con == nil || con.IsCLI {
		return false
	}
	if len(args) != 0 {
