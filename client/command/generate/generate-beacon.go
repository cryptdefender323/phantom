...
func GenerateBeaconCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func shouldRunGenerateBeaconForm(cmd *cobra.Command, con *console.PhantomClient, args []string) bool {
