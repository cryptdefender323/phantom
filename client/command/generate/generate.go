...
const (
	crossCompilerInfoURL = "https://github.com/cryptdefender3232/phantom/wiki/Cross-Compiling-Implants"
)
...
func GenerateCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func shouldRunGenerateForm(cmd *cobra.Command, con *console.PhantomClient, args []string) bool {
...
func saveLocation(save, DefaultName string, con *console.PhantomClient) (string, error) {
	var saveTo string
	if save == "" {
		save, _ = os.Getwd()
	}
...
func parseCompileFlags(cmd *cobra.Command, con *console.PhantomClient) (string, *clientpb.ImplantConfig) {
	var name string
...
func parseShellcodeFlags(cmd *cobra.Command, targetOS string, configFormat clientpb.OutputFormat, con *console.PhantomClient) (*clientpb.ShellcodeConfig, error) {
...
func fetchShellcodeEncoderMap(con *console.PhantomClient) (*clientpb.ShellcodeEncoderMap, error) {
...
func parseShellcodeEncoderFlag(cmd *cobra.Command, targetArch string, configFormat clientpb.OutputFormat, con *console.PhantomClient) (clientpb.ShellcodeEncoder, error) {
...
func parseTrafficEncoderArgs(cmd *cobra.Command, httpC2Enabled bool, con *console.PhantomClient) (bool, []*commonpb.File) {
...
func getTargets(targetOS string, targetArch string, con *console.PhantomClient) (string, string) {
...
func applySpoofMetadataToBuild(implantBuildID string, implantName string, spoofMetadata *clientpb.SpoofMetadataConfig, con *console.PhantomClient) error {
...
func printSpoofMetadataSummary(spoofMetadata *clientpb.SpoofMetadataConfig, con *console.PhantomClient) {
...
func outputSavePath(save string, defaultName string, config *clientpb.ImplantConfig, con *console.PhantomClient) (string, error) {
...
func externalBuild(name string, config *clientpb.ImplantConfig, spoofMetadata *clientpb.SpoofMetadataConfig, save string, con *console.PhantomClient) (*commonpb.File, error) {
...
func compile(name string, config *clientpb.ImplantConfig, spoofMetadata *clientpb.SpoofMetadataConfig, save string, con *console.PhantomClient) (*commonpb.File, error) {
	if config.IsBeacon {
		interval := time.Duration(config.BeaconInterval)
...
func checkBuildTargetCompatibility(format clientpb.OutputFormat, targetOS string, targetArch string, con *console.PhantomClient) bool {
...
func warnMissingCrossCompiler(format clientpb.OutputFormat, targetOS string, targetArch string, con *console.PhantomClient) bool {
...
func findExternalBuilders(config *clientpb.ImplantConfig, con *console.PhantomClient) ([]*clientpb.Builder, error) {
...
func selectExternalBuilder(builders []*clientpb.Builder, _ *console.PhantomClient) (*clientpb.Builder, error) {
	choices := []string{}
