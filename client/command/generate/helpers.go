...
// GetPhantomBinary - Get the binary of an implant based on it's profile.
func GetPhantomBinary(profile *clientpb.ImplantProfile, con *console.PhantomClient) ([]byte, error) {
	var data []byte
...
func compilerTargets(con *console.PhantomClient) (*clientpb.Compiler, error) {
...
func registerTargetFlagCompletion(cmd *cobra.Command, name string, valuesFn func(*clientpb.Compiler) []string, con *console.PhantomClient) {
	if cmd == nil {
		return
	}
...
func registerImplantTargetFlagCompletions(cmd *cobra.Command, con *console.PhantomClient) {
...
func ArchCompleter(con *console.PhantomClient) carapace.Action {
...
func OSCompleter(con *console.PhantomClient) carapace.Action {
	return carapace.ActionCallback(func(_ carapace.Context) carapace.Action {
		compiler, err := compilerTargets(con)
		if err != nil {
			return carapace.ActionMessage("No compiler info: %s", err.Error())
...
func HTTPC2Completer(con *console.PhantomClient) carapace.Action {
...
func TrafficEncodersCompleter(con *console.PhantomClient) carapace.Action {
	return carapace.ActionCallback(func(c carapace.Context) carapace.Action {
		grpcCtx, cancel := con.GrpcContext(nil)
		defer cancel()
