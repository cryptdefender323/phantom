...
func ProfilesCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
...
func PrintProfiles(profiles []*clientpb.ImplantProfile, con *console.PhantomClient) {
	tw := table.NewWriter()
...
func getImplantProfiles(con *console.PhantomClient) []*clientpb.ImplantProfile {
...
func GetImplantProfileByName(name string, con *console.PhantomClient) *clientpb.ImplantProfile {
	pbProfiles, err := con.Rpc.ImplantProfiles(context.Background(), &commonpb.Empty{})
	if err != nil {
		con.PrintErrorf("%s\n", err)
		return nil
...
func PrintProfileInfo(name string, con *console.PhantomClient) {
...
func ProfileNameCompleter(con *console.PhantomClient) carapace.Action {
