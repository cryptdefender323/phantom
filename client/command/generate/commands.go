...
// coreImplantFlags binds all flags common to all phantom implant types.
// This is used by all phantom compilation and profiles generation commands.
...
func coreImplantFlagCompletions(cmd *cobra.Command, con *console.PhantomClient) {
...
func compileImplantFlags(name string, cmd *cobra.Command) {
	flags.Bind(name, false, cmd, func(f *pflag.FlagSet) {
		f.StringP("name", "N", "", "agent name")
		f.StringP("template", "I", "phantom", "implant code template")
