...
// GenerateInfoCmd - Display information about the Phantom server's compiler configuration.
func GenerateInfoCmd(cmd *cobra.Command, con *console.PhantomClient, args []string) {
