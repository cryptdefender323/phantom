...
[Donut](https://github.com/phantomproject/wasm-donut) for MacOS, converts `darwin/arm64` and `darwin/amd64` `.dylib` files into MacOS PIC shellcode, can be used as a CLI or imported as a golang library.
