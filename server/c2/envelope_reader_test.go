...
func measureEnvelopeReadAlloc(t *testing.T, readFunc func(net.Conn) (*phantompb.Envelope, error), frame []byte) (uint64, error) {
	t.Helper()
...
func assertLargeTruncatedFrameHasBoundedAlloc(t *testing.T, readFunc func(net.Conn) (*phantompb.Envelope, error)) {
	t.Helper()
