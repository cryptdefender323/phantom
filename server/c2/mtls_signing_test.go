...
func newImplantSignedEnvelopeFrame(t *testing.T, peerPrivateKey string, envelope *phantompb.Envelope) ([]byte, uint64, ed25519.PublicKey) {
	t.Helper()
...
func newServerSignedEnvelopeFrame(t *testing.T, envelope *phantompb.Envelope) []byte {
	t.Helper()
...
func TestMTLSSocketReadEnvelopeRejectsUnsupportedAlgorithm(t *testing.T) {
	...
	frame, keyID, pub := newImplantSignedEnvelopeFrame(t, "peer-private-key-test", &phantompb.Envelope{
...
func TestMTLSSocketReadEnvelopeRejectsWrongKeyID(t *testing.T) {
	...
	frame, keyID, _ := newImplantSignedEnvelopeFrame(t, "peer-private-key-test", &phantompb.Envelope{
		Type: phantompb.MsgPing,
		Data: []byte("hello"),
	})
...
func TestMTLSSocketReadEnvelopeRejectsTruncatedSignature(t *testing.T) {
	...
	frame, _, _ := newImplantSignedEnvelopeFrame(t, "peer-private-key-test", &phantompb.Envelope{
		Type: phantompb.MsgPing,
		Data: []byte("hello"),
	})
...
func TestMTLSImplantReadEnvelopeRejectsInvalidServerSignature(t *testing.T) {
	frame := newServerSignedEnvelopeFrame(t, &phantompb.Envelope{
		Type: phantompb.MsgPing,
		Data: []byte("hello"),
	})
