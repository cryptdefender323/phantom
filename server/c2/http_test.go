...
// 	implantTransports "github.com/cryptdefender3232/phantom/implant/phantom/transports/httpclient"
...
// 	client := implantTransports.PhantomHTTPClient{}
// 	baseURL := &url.URL{
// 		Scheme: "http",
// 		Host:   "127.0.0.1:8888",
...
// 	httpSessionInit := &phantompb.HTTPSessionInit{Key: sKey[:]}
