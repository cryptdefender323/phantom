...
import (
	...
	"github.com/cryptdefender3232/phantom/protobuf/dnspb"
...
func StartDNSListener(bindIface string, lport uint16, domains []string, canaries bool) *PhantomDNSServer {
	// StartPivotListener()
	server := &PhantomDNSServer{
...
func (s *DNSSession) StageOutgoingEnvelope(envelope *phantompb.Envelope) error {
...
// PhantomDNSServer - DNS server implementation
type PhantomDNSServer struct {
	server       *dns.Server
	sessions     *sync.Map
	messages     *sync.Map
	TTL          uint32
...
func (s *PhantomDNSServer) Shutdown() error {
...
func (s *PhantomDNSServer) ListenAndServe() error {
	return s.server.ListenAndServe()
}

func (s *PhantomDNSServer) startInitGC() {
	// Tests construct PhantomDNSServer directly; only start GC for real listeners.
	if s.gcStop != nil {
		return
	}
...
func (s *PhantomDNSServer) gcPendingInits() {
	now := time.Now()
	var deleted int64
...
func (s *PhantomDNSServer) HandleDNSRequest(domains []string, canaries bool, writer dns.ResponseWriter, req *dns.Msg) {
...
func (s *PhantomDNSServer) isC2SubDomain(domains []string, reqDomain string) (bool, string) {
...
func (s *PhantomDNSServer) handleC2(domain string, req *dns.Msg) *dns.Msg {
...
func (s *PhantomDNSServer) decodeSubdata(subdomain string) (*dnspb.DNSMessage, uint32, error) {
...
func (s *PhantomDNSServer) nameErrorResp(req *dns.Msg) *dns.Msg {
	resp := new(dns.Msg)
...
func (s *PhantomDNSServer) emptySuccessResp(req *dns.Msg) *dns.Msg {
	resp := new(dns.Msg)
	resp.SetReply(req)
	resp.Authoritative = true
	return resp
...
func (s *PhantomDNSServer) refusedErrorResp(req *dns.Msg) *dns.Msg {
	resp := new(dns.Msg)
...
func (s *PhantomDNSServer) accumulateInitData(msg *dnspb.DNSMessage) ([]byte, bool, error) {
	if msg.Size == 0 {
...
func (s *PhantomDNSServer) deletePendingInit(id uint32) {
	if _, loaded := s.messages.LoadAndDelete(id); loaded {
		s.pendingInits.Add(-1)
	}
}

func (s *PhantomDNSServer) handleDNSSessionInit(domain string, msg *dnspb.DNSMessage, checksum uint32, req *dns.Msg) *dns.Msg {
...
func (s *PhantomDNSServer) handlePoll(domain string, msg *dnspb.DNSMessage, checksum uint32, req *dns.Msg) *dns.Msg {
...
func (s *PhantomDNSServer) handleDataFromImplant(domain string, msg *dnspb.DNSMessage, checksum uint32, req *dns.Msg) *dns.Msg {
...
func (s *PhantomDNSServer) handleDataToImplant(domain string, msg *dnspb.DNSMessage, checksum uint32, req *dns.Msg) *dns.Msg {
...
func (s *PhantomDNSServer) handleClear(domain string, msg *dnspb.DNSMessage, checksum uint32, req *dns.Msg) *dns.Msg {
...
func (s *PhantomDNSServer) handleNOP(domain string, msg *dnspb.DNSMessage, checksum uint32, req *dns.Msg) *dns.Msg {
...
func (s *PhantomDNSServer) handleCanary(req *dns.Msg) *dns.Msg {
