...
func (e *executor) callMV(ctx context.Context, args moveToolArgs) (string, error) {
	...
	_, err = callTargetRPC(
		ctx,
		target,
		func(callCtx context.Context, req *commonpb.Request) (*phantompb.Mv, error) {
			return e.backend.Mv(callCtx, &phantompb.MvReq{Request: req, Src: args.Src, Dst: args.Dst})
		},
		func() *phantompb.Mv { return &phantompb.Mv{} },
	)
	if err != nil {
		return "", err
	}
...
func (e *executor) callCP(ctx context.Context, args copyToolArgs) (string, error) {
	...
	resp, err := callTargetRPC(
		ctx,
		target,
		func(callCtx context.Context, req *commonpb.Request) (*phantompb.Cp, error) {
			return e.backend.Cp(callCtx, &phantompb.CpReq{Request: req, Src: args.Src, Dst: args.Dst})
		},
		func() *phantompb.Cp { return &phantompb.Cp{} },
	)
	if err != nil {
		return "", err
	}
...
func (e *executor) callRM(ctx context.Context, args removeToolArgs) (string, error) {
	...
	resp, err := callTargetRPC(
		ctx,
		target,
		func(callCtx context.Context, req *commonpb.Request) (*phantompb.Rm, error) {
			return e.backend.Rm(callCtx, &phantompb.RmReq{
				Request:   req,
				Path:      args.Path,
		...
		func() *phantompb.Rm { return &phantompb.Rm{} },
	)
	if err != nil {
		return "", err
	}
...
func (e *executor) callMkdir(ctx context.Context, args mkdirToolArgs) (string, error) {
	...
	resp, err := callTargetRPC(
		ctx,
		target,
		func(callCtx context.Context, req *commonpb.Request) (*phantompb.Mkdir, error) {
			return e.backend.Mkdir(callCtx, &phantompb.MkdirReq{Request: req, Path: args.Path})
		},
		func() *phantompb.Mkdir { return &phantompb.Mkdir{} },
	)
	if err != nil {
		return "", err
	}
...
func (e *executor) callCD(ctx context.Context, args cdToolArgs) (string, error) {
	...
	resp, err := callTargetRPC(
		ctx,
		target,
		func(callCtx context.Context, req *commonpb.Request) (*phantompb.Pwd, error) {
			return e.backend.Cd(callCtx, &phantompb.CdReq{Request: req, Path: args.Path})
		},
		func() *phantompb.Pwd { return &phantompb.Pwd{} },
	)
	if err != nil {
		return "", err
	}
...
func (e *executor) callHeadTail(ctx context.Context, args headTailToolArgs, head bool) (string, error) {
	...
	resp, err := callTargetRPC(
		ctx,
		target,
		func(callCtx context.Context, req *commonpb.Request) (*phantompb.Download, error) {
			return e.backend.Download(callCtx, &phantompb.DownloadReq{
				Request:          req,
		...
		func() *phantompb.Download { return &phantompb.Download{} },
	)
	if err != nil {
		return "", err
	}
...
func (e *executor) callChmod(ctx context.Context, args chmodToolArgs) (string, error) {
	...
	resp, err := callTargetRPC(
		ctx,
		target,
		func(callCtx context.Context, req *commonpb.Request) (*phantompb.Chmod, error) {
			return e.backend.Chmod(callCtx, &phantompb.ChmodReq{
				Request:   req,
				Path:      args.Path,
		...
		func() *phantompb.Chmod { return &phantompb.Chmod{} },
	)
	if err != nil {
		return "", err
	}
...
func (e *executor) callChown(ctx context.Context, args chownToolArgs) (string, error) {
	...
	resp, err := callTargetRPC(
		ctx,
		target,
		func(callCtx context.Context, req *commonpb.Request) (*phantompb.Chown, error) {
			return e.backend.Chown(callCtx, &phantompb.ChownReq{
				Request:   req,
				Path:      args.Path,
				Uid:       args.UID,
				Gid:       args.GID,
		...
		func() *phantompb.Chown { return &phantompb.Chown{} },
	)
	if err != nil {
		return "", err
	}
...
func (e *executor) callChtimes(ctx context.Context, args chtimesToolArgs) (string, error) {
	...
	resp, err := callTargetRPC(
		ctx,
		target,
		func(callCtx context.Context, req *commonpb.Request) (*phantompb.Chtimes, error) {
			return e.backend.Chtimes(callCtx, &phantompb.ChtimesReq{
				Request: req,
				Path:    args.Path,
		...
		func() *phantompb.Chtimes { return &phantompb.Chtimes{} },
	)
	if err != nil {
		return "", err
	}
...
func (e *executor) callMount(ctx context.Context, args targetArgs) (string, error) {
	...
	resp, err := callTargetRPC(
		ctx,
		target,
		func(callCtx context.Context, req *commonpb.Request) (*phantompb.Mount, error) {
			return e.backend.Mount(callCtx, &phantompb.MountReq{Request: req})
		},
		func() *phantompb.Mount { return &phantompb.Mount{} },
	)
	if err != nil {
		return "", err
	}
