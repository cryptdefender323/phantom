...
// NewExecutor returns the Phantom-backed tool executor used by the AI agent loop.
...
func (e *executor) ToolDefinitions() []serverai.AgenticToolDefinition {
	...
	definitions = append(definitions, registryToolDefinitions()...)
	return definitions
}
...
func (e *executor) CallTool(ctx context.Context, name string, arguments string) (string, error) {
	...
	default:
		...
		if result, handled, err := e.callRegistryTool(ctx, name, arguments); handled {
			return result, err
		}
...
func (e *executor) callLS(ctx context.Context, args lsToolArgs) (string, error) {
	...
	resp, err := e.backend.Ls(callCtx, &phantompb.LsReq{
		Request: req,
		Path:    args.Path,
	})
	if err != nil {
...
func (e *executor) callCat(ctx context.Context, args catToolArgs) (string, error) {
	...
	resp, err := e.backend.Download(callCtx, &phantompb.DownloadReq{
		Request:          req,
...
func (e *executor) callPWD(ctx context.Context, args targetArgs) (string, error) {
	...
	resp, err := e.backend.Pwd(callCtx, &phantompb.PwdReq{Request: req})
	if err != nil {
		return "", err
	}
	if err := genericResponseError(resp.Response); err != nil {
