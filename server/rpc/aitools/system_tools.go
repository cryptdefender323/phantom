...
func (e *executor) callIfconfig(ctx context.Context, args targetArgs) (string, error) {
	...
	resp, err := callTargetRPC(
		ctx,
		target,
		func(callCtx context.Context, req *commonpb.Request) (*phantompb.Ifconfig, error) {
			return e.backend.Ifconfig(callCtx, &phantompb.IfconfigReq{Request: req})
		},
		func() *phantompb.Ifconfig { return &phantompb.Ifconfig{} },
	)
	if err != nil {
		return "", err
	}
...
func (e *executor) callNetstat(ctx context.Context, args netstatToolArgs) (string, error) {
	...
	resp, err := callTargetRPC(
		ctx,
		target,
		func(callCtx context.Context, req *commonpb.Request) (*phantompb.Netstat, error) {
			return e.backend.Netstat(callCtx, &phantompb.NetstatReq{
				Request:   req,
				TCP:       args.TCP,
				UDP:       args.UDP,
				IP4:       args.IP4,
		...
		func() *phantompb.Netstat { return &phantompb.Netstat{} },
	)
	if err != nil {
		return "", err
	}
...
func (e *executor) callPS(ctx context.Context, args psToolArgs) (string, error) {
	...
	resp, err := callTargetRPC(
		ctx,
		target,
		func(callCtx context.Context, req *commonpb.Request) (*phantompb.Ps, error) {
			return e.backend.Ps(callCtx, &phantompb.PsReq{
				Request:  req,
				FullInfo: args.FullInfo,
			})
		},
		func() *phantompb.Ps { return &phantompb.Ps{} },
	)
	if err != nil {
		return "", err
	}
...
func (e *executor) callEnv(ctx context.Context, args envToolArgs) (string, error) {
	...
	resp, err := callTargetRPC(
		ctx,
		target,
		func(callCtx context.Context, req *commonpb.Request) (*phantompb.EnvInfo, error) {
			return e.backend.GetEnv(callCtx, &phantompb.EnvReq{
				Request: req,
				Name:    args.Name,
			})
		},
		func() *phantompb.EnvInfo { return &phantompb.EnvInfo{} },
	)
	if err != nil {
		return "", err
	}
...
func (e *executor) callPing(ctx context.Context, args pingToolArgs) (string, error) {
	...
	resp, err := callTargetRPC(
		ctx,
		target,
		func(callCtx context.Context, req *commonpb.Request) (*phantompb.Ping, error) {
			return e.backend.Ping(callCtx, &phantompb.Ping{
				Request: req,
				Nonce:   nonce,
			})
		},
		func() *phantompb.Ping { return &phantompb.Ping{} },
	)
	if err != nil {
		return "", err
	}
...
func (e *executor) callScreenshot(ctx context.Context, args screenshotToolArgs) (string, error) {
	...
	resp, err := callTargetRPC(
		ctx,
		target,
		func(callCtx context.Context, req *commonpb.Request) (*phantompb.Screenshot, error) {
			return e.backend.Screenshot(callCtx, &phantompb.ScreenshotReq{Request: req})
		},
		func() *phantompb.Screenshot { return &phantompb.Screenshot{} },
	)
	if err != nil {
		return "", err
	}
...
func (e *executor) callExec(ctx context.Context, args execToolArgs) (string, error) {
	...
	if args.UseToken || args.HideWindow || args.PPID != 0 {
		...
		resp, err = callTargetRPC(
			ctx,
			target,
			func(callCtx context.Context, req *commonpb.Request) (*phantompb.Execute, error) {
				return e.backend.ExecuteWindows(callCtx, &phantompb.ExecuteWindowsReq{
					Request:    req,
					Path:       args.Path,
					Args:       args.Args,
			...
			func() *phantompb.Execute { return &phantompb.Execute{} },
		)
	} else {
		resp, err = callTargetRPC(
			ctx,
			target,
			func(callCtx context.Context, req *commonpb.Request) (*phantompb.Execute, error) {
				return e.backend.Execute(callCtx, &phantompb.ExecuteReq{
					Request:        req,
					Path:           args.Path,
					Args:           args.Args,
					Output:         captureOutput,
