...
func (rpc *Server) GetRportFwdListeners(ctx context.Context, req *phantompb.RportFwdListenersReq) (*phantompb.RportFwdListeners, error) {
	resp := &phantompb.RportFwdListeners{Response: &commonpb.Response{}}
...
func (rpc *Server) StartRportFwdListener(ctx context.Context, req *phantompb.RportFwdStartListenerReq) (*phantompb.RportFwdListener, error) {
	if req == nil || req.Request == nil {
		return nil, ErrMissingRequestField
	}

	resp := &phantompb.RportFwdListener{Response: &commonpb.Response{}}
	err := rpc.GenericHandler(req, resp)
	if err != nil {
		return nil, err
	}
...
func (rpc *Server) StopRportFwdListener(ctx context.Context, req *phantompb.RportFwdStopListenerReq) (*phantompb.RportFwdListener, error) {
	if req == nil || req.Request == nil {
		return nil, ErrMissingRequestField
	}
