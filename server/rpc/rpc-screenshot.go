...
func (rpc *Server) Screenshot(ctx context.Context, req *phantompb.ScreenshotReq) (*phantompb.Screenshot, error) {
	resp := &phantompb.Screenshot{Response: &commonpb.Response{}}
