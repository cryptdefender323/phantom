...
func (rpc *Server) PivotSessionListeners(ctx context.Context, req *phantompb.PivotListenersReq) (*phantompb.PivotListeners, error) {
	resp := &phantompb.PivotListeners{Response: &commonpb.Response{}}
...
func (rpc *Server) PivotStartListener(ctx context.Context, req *phantompb.PivotStartListenerReq) (*phantompb.PivotListener, error) {
	resp := &phantompb.PivotListener{Response: &commonpb.Response{}}
	err := rpc.GenericHandler(req, resp)
	if err != nil {
		return nil, err
	}
...
func (rpc *Server) PivotStopListener(ctx context.Context, req *phantompb.PivotStopListenerReq) (*commonpb.Empty, error) {
	resp := &phantompb.PivotListener{Response: &commonpb.Response{}}
	err := rpc.GenericHandler(req, resp)
	if err != nil {
		return nil, err
