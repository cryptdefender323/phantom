...
import (
	...
	"github.com/cryptdefender3232/phantom/server/msf"
)
...
func (rpc *Server) Msf(ctx context.Context, req *clientpb.MSFReq) (*phantompb.Task, error) {
	var os string
	var arch string
...
func (rpc *Server) MsfRemote(ctx context.Context, req *clientpb.MSFRemoteReq) (*phantompb.Task, error) {
	var os string
	var arch string
