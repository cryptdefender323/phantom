...
func (rpc *Server) ExecuteChildren(ctx context.Context, req *phantompb.ExecuteChildrenReq) (*phantompb.ExecuteChildren, error) {
	resp := &phantompb.ExecuteChildren{Response: &commonpb.Response{}}
