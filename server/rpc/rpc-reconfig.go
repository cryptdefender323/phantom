...
func (rpc *Server) Reconfigure(ctx context.Context, req *phantompb.ReconfigureReq) (*phantompb.Reconfigure, error) {
	...
	resp := &phantompb.Reconfigure{Response: &commonpb.Response{}}
