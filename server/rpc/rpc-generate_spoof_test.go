...
import (
	...
	generatePkg "github.com/cryptdefender3232/phantom/server/generate"
...
func TestGenerateSpoofMetadataAppliesPETimestampOverBufnet(t *testing.T) {
	...
	t.Cleanup(func() {
		...
		_ = os.RemoveAll(filepath.Join(generatePkg.GetPhantomsDir(), "windows", "amd64", buildName))
	})
...
func newBufnetRPCClient(t *testing.T) (rpcpb.PhantomRPCClient, func()) {
	t.Helper()
	...
	rpcpb.RegisterPhantomRPCServer(grpcServer, &Server{})
