...
var (
	...
	builderMethods = map[string]bool{
		"/rpcpb.PhantomRPC/GetVersion": true,

		"/rpcpb.PhantomRPC/GenerateExternalGetBuildConfig": true,
		"/rpcpb.PhantomRPC/GenerateExternalSaveBuild":      true,
		"/rpcpb.PhantomRPC/BuilderRegister":                true,
		"/rpcpb.PhantomRPC/BuilderTrigger":                 true,
		"/rpcpb.PhantomRPC/Builders":                       true,
	}
	// Crackstation - Allowed methods
	crackstationMethods = map[string]bool{
		"/rpcpb.PhantomRPC/GetVersion": true,

		"/rpcpb.PhantomRPC/CrackstationRegister":   true,
		"/rpcpb.PhantomRPC/CrackstationTrigger":    true,
		"/rpcpb.PhantomRPC/CrackstationBenchmark":  true,
		"/rpcpb.PhantomRPC/Crackstations":          true,
		"/rpcpb.PhantomRPC/CrackTaskByID":          true,
		"/rpcpb.PhantomRPC/CrackTaskUpdate":        true,
		"/rpcpb.PhantomRPC/CrackFilesList":         true,
		"/rpcpb.PhantomRPC/CrackFileCreate":        true,
		"/rpcpb.PhantomRPC/CrackFileChunkUpload":   true,
		"/rpcpb.PhantomRPC/CrackFileChunkDownload": true,
		"/rpcpb.PhantomRPC/CrackFileComplete":      true,
		"/rpcpb.PhantomRPC/CrackFileDelete":        true,
	}
)
