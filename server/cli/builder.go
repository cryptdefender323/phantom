...
import (
	...
	"github.com/cryptdefender3232/phantom/server/builder"
	...
	"github.com/cryptdefender3232/phantom/server/version"
...
var builderCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		builderLog.Infof("Initializing Phantom external builder - %s", version.FullVersion())
...
func createBuilder(cmd *cobra.Command, configPath string, mutex *sync.Mutex) (*builder.Builder, error) {
	...
	externalBuilder.Templates = []string{"phantom"}
