...
import (
	...
	clientassets "github.com/cryptdefender3232/phantom/client/assets"
	...
	servertransport "github.com/cryptdefender3232/phantom/server/transport"
...
func mustMTLSBufconnClient(t *testing.T, listener *bufconn.Listener, config *clientassets.ClientConfig) (rpcpb.PhantomRPCClient, *grpc.ClientConn, error) {
	t.Helper()
	...
	return rpcpb.NewPhantomRPCClient(conn), conn, nil
}
