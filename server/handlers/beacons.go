...
func beaconRegisterHandler(implantConn *core.ImplantConnection, data []byte) *phantompb.Envelope {
	beaconReg := &phantompb.BeaconRegister{}
...
func auditLogBeacon(beacon *models.Beacon, register *phantompb.Register) {
...
func beaconTasksHandler(implantConn *core.ImplantConnection, data []byte) *phantompb.Envelope {
	beaconTasks := &phantompb.BeaconTasks{}
	...
	taskData, err := proto.Marshal(&phantompb.BeaconTasks{Tasks: tasks})
	if err != nil {
	...
	return &phantompb.Envelope{
		Type: phantompb.MsgBeaconTasks,
		Data: taskData,
	}
}

func beaconTaskResults(beaconID string, taskEnvelopes []*phantompb.Envelope) *phantompb.Envelope {
