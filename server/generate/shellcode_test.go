...
import (
	...
	"github.com/cryptdefender3232/phantom/server/encoders/shellcode/sgn"
)

func TestPhantomShellcodeWindows(t *testing.T) {
...
func multiWindowsLibraryShellcode(t *testing.T, debug bool) {
	...
	binPath, err := PhantomShellcode(name, build, config, httpC2Config.ImplantConfig)
	if err != nil {
		t.Fatalf("%v", err)
	}
...
func TestPhantomShellcodeLinux(t *testing.T) {
...
func TestPhantomShellcodeDarwin(t *testing.T) {
