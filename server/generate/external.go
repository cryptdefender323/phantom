...
// PhantomExternal - Generates the cryptographic keys for the implant but compiles no code
func PhantomExternal(name string, config *clientpb.ImplantConfig) (*clientpb.ExternalImplantConfig, error) {
