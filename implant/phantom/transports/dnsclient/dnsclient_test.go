...
func TestSplitBufferBase32(t *testing.T) {
	...
	for _, client := range []*PhantomDNSClient{client1, client2, client3} {
...
func clientSplitBuffer(t *testing.T, client *PhantomDNSClient, encoder encoders.Encoder, testData []byte) {
	msg := &dnspb.DNSMessage{
		Type: dnspb.DNSMessageType_DATA_FROM_IMPLANT,
		Size: uint32(len(testData)),
	}
