...
func nsLinuxIfconfig(interfaces *phantompb.Ifconfig) {
...
func ifconfigLinux() *phantompb.Ifconfig {
...
func ifconfigParseInterfaces(netInterfaces []net.Interface, interfaces *phantompb.Ifconfig, namespacePath ...string) {
