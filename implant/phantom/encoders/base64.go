...
var phantomBase64 = base64.NewEncoding(base64Alphabet).WithPadding(base64.NoPadding)

// Encode - Base64 Encode
func (e Base64Encoder) Encode(data []byte) ([]byte, error) {
	return []byte(phantomBase64.EncodeToString(data)), nil
}

// Decode - Base64 Decode
func (e Base64Encoder) Decode(data []byte) ([]byte, error) {
	return phantomBase64.DecodeString(string(data))
}
