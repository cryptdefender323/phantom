...
const (
	...
	// MsgRegister - Initial message from phantom with metadata
	...
	// MsgKillSessionReq - Kill request to the phantom process
	MsgKillSessionReq
	...
	MsgExecuteAssembly
	// MsgInvokeMigrateReq - Spawn a new phantom in a designated process
	MsgInvokeMigrateReq
