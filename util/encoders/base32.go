...
var phantomBase32 = base32.NewEncoding(base32Alphabet).WithPadding(base32.NoPadding)

// Encode - Base32 Encode
func (e Base32) Encode(data []byte) ([]byte, error) {
	return []byte(phantomBase32.EncodeToString(data)), nil
}

// Decode - Base32 Decode
func (e Base32) Decode(data []byte) ([]byte, error) {
	return phantomBase32.DecodeString(string(data))
}
